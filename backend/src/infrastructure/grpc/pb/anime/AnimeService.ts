...
import type { Ok as _anime_Ok, Ok__Output as _anime_Ok__Output } from '../anime/Ok';
...
export interface AnimeServiceClient extends grpc.Client {
  ...
  FetchAnimeRating(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  FetchAnimeRating(metadata: grpc.Metadata, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  FetchAnimeRating(options: grpc.CallOptions, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  FetchAnimeRating(callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  fetchAnimeRating(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  fetchAnimeRating(metadata: grpc.Metadata, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  fetchAnimeRating(options: grpc.CallOptions, callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
  fetchAnimeRating(callback: grpc.requestCallback<_anime_Ok__Output>): grpc.ClientWritableStream<_anime_AnimeRating>;
...
export interface AnimeServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  FetchAnimeRating: grpc.handleClientStreamingCall<_anime_AnimeRating__Output, _anime_Ok>;
...
export interface AnimeServiceDefinition extends grpc.ServiceDefinition {
  ...
  FetchAnimeRating: MethodDefinition<_anime_AnimeRating, _anime_Ok, _anime_AnimeRating__Output, _anime_Ok__Output>
}
